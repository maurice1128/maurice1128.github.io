...
if special == 2|4
dosage_15d_MDS =[dosage,median(aim_raw(22:36))]
end

%% 15d Dosage Median in PD
if special == 1|3
dosage_15d_MPD =[dosage,median(aim_raw(22:36))]
end
