...
Leave-one-SEED-out CV, 6 spastic vs 18 weak, all 4 LmR channels, window [1.00, 9.73].
...
assert X.shape == (24, 4) and y.sum() == 6
...
json.dump({"prereg": "PREREG_lmr_only_r223.md sha256 8f954702cd46a99adc6a",
           "design": "leave-one-SEED-out, 6 spastic vs 18 weak, 4 LmR channels, window [1.00, 9.73]",
           ...
           "permutation_null": {"method": "exhaustive over C(24,6)",
                                ...
                                "proportion": ge / tot}},
          io.open(os.path.join(PAPER, "LMRONLY_r223.json"), "w", encoding="utf-8"), indent=1)
print("\ndeposited paper/LMRONLY_r223.json")
