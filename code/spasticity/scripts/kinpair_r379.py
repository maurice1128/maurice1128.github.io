...
OUT = r"C:\Users\maurice\Desktop\spasticity_paper\paper\KINPAIR_r379.json"
PREREG_SHA = "751e027147fdf90318fb2da4e70dbfc981e02d61a30a56d89896172fa76101cd"
SETTLE, T1 = 1.0, 9.73

LADDER = [(0.00625, "R289KV00625"), (0.0125, "R289KV0125"),
          (0.035, "R291KV0035"), (0.070, "R291KV0070")]
CONTROL = ["R151W", "R169W090", "R169W095", "R174W870", "R174W892", "R174W915"]
...
def main():
    res = {"registration": "PREREG_kinpair_r378.md", "registration_sha256": PREREG_SHA,
    ...
    res["dfweak"] = {"n_cells": len(ctags),
                      "n_gate_G": sum(1 for t in ctags if res["cells"][t].get("gate_G")),
                      "seed_means": ctrl}
    print("DFWEAK gate-G %d/%d" % (res["dfweak"]["n_gate_G"], len(ctags)))
