...
json.dump(out, io.open(r"C:\Users\maurice\Desktop\spasticity_paper\paper\PRIMARYB_RESULT_r179.json","w",encoding="utf-8"), indent=1)
print("\nwrote PRIMARYB_RESULT_r179.json")
