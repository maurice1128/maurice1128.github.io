...
OUT = r"C:\Users\maurice\Desktop\spasticity_paper\paper\RECTIFIER_r385.json"
PREREG_SHA = "8c8731ad3496e8d220087b8658e32d3bb24ca7c16ea55ff61272e012fa3cfb52"
...
def main():
    res = {"registration": "PREREG_rectifier_r382.md", "registration_sha256": PREREG_SHA,
    ...
    print("CONTROL n=%d  BETA_abs [%+.6f, %+.6f]  mean %+.6f   [BETWEEN-SCENARIO, sec 4]"
    ...
    for kv, fam in LADDER:
        ...
        if n_ok < 4:
            ...
            e["vs_control_BETWEEN_SCENARIO"] = cmp_arms(s, c)
